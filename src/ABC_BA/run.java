...
public class run {
    ...
    public static void callmain() throws IOException {
        ...
        Collections.sort(Code.Run.Load,Collections.reverseOrder());
        Collections.sort(Code.Run.Migration_cost,Collections.reverseOrder());
        Collections.sort(Code.Run.Energy_consumption,Collections.reverseOrder());
        Collections.sort(Code.Run.Resource_availability);
    }
